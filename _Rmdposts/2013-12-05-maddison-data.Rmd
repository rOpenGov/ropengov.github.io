...
```{rmaddison1, echo=TRUE, echo=TRUE, message=FALSE, warning=FALSE}
library(gdata)
...
```{rmaddison2, echo=TRUE, echo=TRUE, message=FALSE, warning=FALSE}
...
```{rmaddison3, echo=TRUE, echo=TRUE, message=FALSE, warning=FALSE}
...
```{rmaddison4, echo=TRUE, echo=TRUE, message=FALSE, warning=FALSE}
...
```{rmaddison5, echo=TRUE, echo=TRUE, message=FALSE, warning=FALSE, fig.width=12, fig.height=8}
library(ggplot2)
