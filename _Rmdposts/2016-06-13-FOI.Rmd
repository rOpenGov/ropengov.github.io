...
Let us compare the [relative increase in publisher costs](https://github.com/antagomir/temp/blob/master/20160610/table/cost_by_publisher_year_relative.csv). The costs are normalized to 1 in 2010, and the top 10 publishers with the highest cost increase in 2010-2015 are shown. The `r sum(!(!is.na(subset(dfs, Year == 2010)$Costs) & !is.na(subset(dfs, Year == 2015)$Costs)))` publishers that did not have declared costs in 2010 or 2015 (see [here](https://github.com/antagomir/temp/blob/master/20160610/table/cost_by_publisher_year.csv)) are excluded.
...
Finally, let us compare the [relative increase in costs across the institutions](https://github.com/antagomir/temp/blob/master/20160610/table/cost_by_organization_year_relative.csv). The costs are normalized to 1 in 2010, and the top 10 organizations with the highest cost increase in 2010-2015 are shown. The `r sum(!(!is.na(subset(dfs, Year == 2010)$Costs) & !is.na(subset(dfs, Year == 2015)$Costs)))` organizations that did not have declared costs in 2010 or 2015 (see [here](https://github.com/antagomir/temp/blob/master/20160610/table/cost_by_organization_year.csv)) are excluded.
