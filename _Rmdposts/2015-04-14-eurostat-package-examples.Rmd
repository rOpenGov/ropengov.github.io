...
## Time-series at the regional level

First we download the data and convert the time column into numeric format.
...
### Labelling the data using function
...
### Retrieving and manipulating the spatial
...
### Fortify the shapefile into data.frame and ready for ggplot2-plotting
...
We are done! That was a small exercise on how to use the main functions in `eurostat`-package. Hope you find the package useful in your work. All contributions are warmly welcome at: <https://github.com/ropengov/eurostat>
