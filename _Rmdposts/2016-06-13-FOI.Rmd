...
institutions](http://openscience.fi/-/transparency-and-openness-to-scientific-publishing-the-finnish-research-organisations-pay-millions-of-euros-annually-to-the-large-publishers) has been released by the Open Science Initiative of the Finnish Ministry of Education (ATT). The data set is available at the [ATT website](http://openscience.fi/publisher_costs).
